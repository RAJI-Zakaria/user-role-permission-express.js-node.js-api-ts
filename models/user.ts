...
export type userOptionalAttributes = "avatar" | "birthday" | "created_at" | "updated_at";
...
export class user extends Model<userAttributes, userCreationAttributes> implements userAttributes {
  ...
  setRole_id_role_user_roles!: Sequelize.BelongsToManySetAssociationsMixin<role, roleId>;
  addRole_id_role_user_role!: Sequelize.BelongsToManyAddAssociationMixin<role, roleId>;
  addRole_id_role_user_roles!: Sequelize.BelongsToManyAddAssociationsMixin<role, roleId>;
  createRole_id_role_user_role!: Sequelize.BelongsToManyCreateAssociationMixin<role>;
  removeRole_id_role_user_role!: Sequelize.BelongsToManyRemoveAssociationMixin<role, roleId>;
  removeRole_id_role_user_roles!: Sequelize.BelongsToManyRemoveAssociationsMixin<role, roleId>;
  hasRole_id_role_user_role!: Sequelize.BelongsToManyHasAssociationMixin<role, roleId>;
  hasRole_id_role_user_roles!: Sequelize.BelongsToManyHasAssociationsMixin<role, roleId>;
