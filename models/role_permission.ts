...
export type role_permissionCreationAttributes = Optional<role_permissionAttributes, role_permissionOptionalAttributes>;

export class role_permission extends Model<role_permissionAttributes, role_permissionCreationAttributes> implements role_permissionAttributes {
  permission_id!: number;
  role_id!: number;
  created_at!: Date;
  updated_at!: Date;
